 ...
 * @since 1.0.0
 */
public class CaseWhenOrBuilderImpl<T extends ServiceProvider> extends PredicateBuilderEndedListenerImpl implements CaseWhenOrBuilder<T>, PredicateBuilder {
