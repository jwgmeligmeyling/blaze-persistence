 ...
 * @since 1.0.0
 */
public class CaseWhenBuilderImpl<T extends ServiceProvider> extends PredicateAndExpressionBuilderEndedListener implements CaseWhenBuilder<T>, CaseWhenThenBuilder<CaseWhenBuilder<T>>, ExpressionBuilder {
