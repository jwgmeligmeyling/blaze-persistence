 ...
 * @since 1.0.0
 */
public class CaseWhenOrThenBuilderImpl<T extends CaseWhenBuilder<?> & ServiceProvider> extends PredicateBuilderEndedListenerImpl implements CaseWhenOrThenBuilder<T>, ExpressionBuilder {
