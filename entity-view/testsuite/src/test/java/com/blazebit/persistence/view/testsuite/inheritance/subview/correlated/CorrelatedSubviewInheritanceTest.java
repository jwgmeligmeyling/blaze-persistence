...
public class CorrelatedSubviewInheritanceTest extends AbstractEntityViewTest {
    ...
    @Category({ NoHibernate42.class, NoHibernate43.class, NoHibernate50.class, NoEclipselink.class, NoMSSQL.class })
    ...
    public <T extends PersonBaseView> void inheritanceQuery(Class<? extends DocumentView> docViewClass, Class<T> baseView, Class<? extends T> oldView, Class<? extends T> youngView) {
        ...
        CriteriaBuilder<Document> criteria = cbf.create(em, Document.class, "d")
            .orderByAsc("id");
        CriteriaBuilder<? extends DocumentView> cb = evm.applySetting(EntityViewSetting.create(docViewClass), criteria);
        List<? extends DocumentView> results = cb.getResultList();
