...
public class BlazeSelectCTECriteriaImpl<T>
        extends AbstractBlazeSelectBaseCTECriteria<T> // TODO: Introduce abstract class
        implements BlazeSelectCTECriteria<T> {

    public BlazeSelectCTECriteriaImpl(BlazeCriteriaBuilderImpl criteriaBuilder, Class<T> returnType) {
